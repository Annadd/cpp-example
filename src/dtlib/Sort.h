...
public:
    ...
    template<typename T>
    static void ShellSelect(T array[], int len, bool min2max = true)
    {
        int d = len;
    ...
    template<typename T>
    static void ShellSelect(Array<T>& array, bool min2max = true)
    {
        ShellSelect(array.array(), array.length(), min2max);
    }
